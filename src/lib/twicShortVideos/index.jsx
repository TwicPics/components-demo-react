    ...
    <div id="twic-short-videos-container">
      <TwicWrapper filename="src/lib/twicShortVideos/index.jsx">
        <TwicAbstract title="Short Videos">
          ...
          <p>
            All videos generated by the TwicPics API are muted, to be looped and played
            automatically. You can think of them as GIFs, but with high quality.
          </p>
          <p>
        ...
        <div className="twic-grid">
          <div className="twic-item">
            ...
            />
            <span>
              <Code>ratio="16/9"</Code>&<Code>mode="cover"</Code>: the video fills the area
            </span>
          </div>
          <div className="twic-item">
            <TwicVideo
          ...
          <div className="twic-item">
            ...
            />
            <span>
              <Code>ratio="1"</Code>&<Code>mode="contain"</Code>: the video sits inside the area
            </span>
          </div>
          <div className="twic-item">
            <TwicVideo
            ...
            />
            <span>
              <Code>ratio="2/3"</Code>,<Code>mode="cover"</Code>: the video fills the area
            </span>
          </div>
        </div>
      </TwicWrapper>
